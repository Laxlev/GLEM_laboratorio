    ...
    private boolean handleMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case 1: // Registrar Solicitudes
                Intent intent1 = new Intent(CancelarSol.this, RegistrarSol.class);  // Use ConsultarSol.this
                startActivity(intent1);
                return true;

            case 2: // Consultar Solicitudes
                Intent intent2 = new Intent(CancelarSol.this, ConsultarSol.class);  // Use ConsultarSol.this
                startActivity(intent2);
                return true;

            case 3: // Cancelar Solicitud
                Intent intent3 = new Intent(CancelarSol.this, CancelarSol.class);  // Use ConsultarSol.this
                startActivity(intent3);
                return true;

            case 4: // Cambio de Horario
                Intent intent4 = new Intent(CancelarSol.this, ConsultarSol.class);  // Use ConsultarSol.this
                startActivity(intent4);
                return true;

            case 5: // Logout
                Intent intent5 = new Intent(CancelarSol.this, MainActivity.class);  // Use ConsultarSol.this
